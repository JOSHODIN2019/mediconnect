...
Run the application.
Capture a fresh screenshot of the current result.
Compare the screenshot against the provided reference image.
Identify every visual difference, including:
Layout
Spacing
Alignment
Typography
...
Create a list of all detected differences.
Fix the differences.
Generate a new screenshot.
Compare again.
Repeat this process until the implementation is visually indistinguishable from the reference image.
...
Retest related functionality to ensure no regressions.
